        ...
        new Thread(()->{
            while(running) {
                ...
                executorService.execute(() -> {
                    handleRequest(pieceLength, pieceAmount, hashValue, serverPeerId, socket);
                });
            }
        }).start();
    }

    public static void handleRequest(int pieceLength, int pieceAmount, byte[] hashValue, String serverPeerId, Socket socket) {
        try {
